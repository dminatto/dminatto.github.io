...
const skills = [
  {
    ...
    Icon: ArchIcon,
    tooltip:
      "Designs distributed systems that grow without breaking. Microservices, queues, and resilient APIs are second nature.",
  },
  {
    category: "Mindset",
    name: "Laser Focus",
    Icon: FocusIcon,
    tooltip:
      "Cuts through noise and zeroes in on what matters. Delivers under pressure without losing precision.",
  },
  {
    category: "Languages",
    name: "Polyglot Dev",
    Icon: PolyglotIcon,
    tooltip:
      "Fluent in multiple stacks — Node.js, Python, TypeScript and beyond. Picks up new languages like new dialects.",
  },
  {
    category: "Curiosity",
    ...
    Icon: CuriousIcon,
    tooltip:
      "Doesn't know everything — and that's the point. Dives headfirst into the unknown and always surfaces with answers.",
  },
  {
    category: "Strategy",
    ...
    Icon: PlanningIcon,
    tooltip:
      "Thinks two sprints ahead. Maps technical debt, aligns roadmaps, and turns ambiguous requirements into clear execution.",
  },
];
